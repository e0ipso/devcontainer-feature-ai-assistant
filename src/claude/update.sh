#!/usr/bin/env bash
# Re-runs the Claude Code installer to update to the latest version.
#
# Invoked during postStart by the 'claude' devcontainer feature when
...
echo "==> Updating Claude Code (postStart)"
